...
To allow communication between the frontend and the backend, it is required to edit the file named *./canary/dstrategies-frontend-deployment.yaml* to add the required **<USERNAME>** and **<OCP_APPS_DOMAIN>**.
