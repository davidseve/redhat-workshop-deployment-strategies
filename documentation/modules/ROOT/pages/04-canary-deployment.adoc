...
Please edit a file named *./canary/dstrategies-back-rollout.yaml* to define **<TIME>** as *30s* and understand the canary deployment strategy:
...
Please edit a file named *./canary/dstrategies-back-analysis-template.yaml* to add the required **<USERNAME>** that helps to reference the user namespace in the healthcheck URL.
