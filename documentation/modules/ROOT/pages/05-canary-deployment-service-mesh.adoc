...
We will deploy a new version *V2.0.0*. To do it, we have to edit the files *./rhsm-canary/edit.values.yaml* to modify the value *v1.0.0* to *V2.0.0*:
...
We will see the dstrategies graph:
...
TODO
.Frontend Interface
image::frontend-canary-service-mesh-v1.png["Frontend Interface"]
