...
We will deploy a new version `V2.0.0`. To do it, we have to edit the file `helm/helm-dstrategies/chart/values/blue-green/values-image-tag.yaml` under `dstrategies-back` set `tag` value to `V2.0.0`
