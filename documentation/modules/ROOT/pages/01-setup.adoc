...
* *{user}-canary-service-mesh*: Will contain the application using Canary deployment with Service Mesh.
...
The ArgoCD web console will give you access to control how the git repo is synced with Openshift, as well as check the real status of the synchronization. In order to log in to the web console, access to _https://argocd-server-user01-gitops-argocd.apps.%CLUSTER%/_
