...
Install it using the https://argoproj.github.io/argo-rollouts/installation/#kubectl-plugin-installation[official documentation]. Then, check that the plugin is correctly installed using the following command:
...
Please fork the repository and clone it in your local machine in order to have full autonomy to make changes and deploy applications. In order to complete this task, follow the next steps:
...
* Clone the repository to your local machine. You can use both SSH and HTTPS URLs.
