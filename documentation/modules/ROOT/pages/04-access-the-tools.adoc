...
1. Access the https://github.com/rhte2023-argo-rollouts/shop-application-helm-chart[Shop application Helm chart] repository and fork it on your GitHub account. If prompted, choose to fork the `main` branch.
