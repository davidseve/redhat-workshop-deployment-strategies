...
Or you can go user this http://dstrategies-frontend-{user}-blue-green.apps.%CLUSTER%/[url]
...
In order to test the online service, it is required to extract the frontend http://dstrategies-frontend-{user}-blue-green.apps.%CLUSTER%/[url]
...
In order to test the new online service, it is required to extract the frontend http://dstrategies-frontend-{user}-blue-green.apps.%CLUSTER%/[url]
